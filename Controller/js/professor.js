...
function cargarUsuarios() {
    tabla.innerHTML = '<tr><th>ID</th><th>Nombre</th><th>Apellido</th><th>Usuario</th><th>Telefono</th><th>Correo</th><th>Materia</th><th>ID ultima clase</th></tr>'
    let peticion = new XMLHttpRequest();
    peticion.open("GET", "Controller/php/profesor.php");
    ...
    peticion.onload = function() {
        ...
        if (datos.error) {
            ...
            for (let index = 0; index < datos.length; index++) {
                ...
                elemento.innerHTML += "<td>" + datos[index].telefono + "</td>";
                elemento.innerHTML += "<td>" + datos[index].correo + "</td>";
                elemento.innerHTML += "<td>" + datos[index].materia + "</td>";
                elemento.innerHTML += "<td>" + datos[index].id_last_class + "</td>";
...
function agregarUsuarios(e) {
    ...
    let peticion = new XMLHttpRequest()
    peticion.open("POST", "Controller/php/insertar_profesor.php");
    ...
    usuario_materia = formulario.materia.value.trim();
    ...
    if (formulario_valido()) {
        ...
        let parametros = `nombre=${usuario_nombre}&apellido=${usuario_apellido}&usuario=${usuario_usuario}&pass=${usuario_pass}&email=${usuario_correo}&telefono=${usuario_telefono}&materia=${usuario_materia}`;
...
function eliminarUsuarios(e) {
    e.preventDefault()
    let peticion = new XMLHttpRequest()
    peticion.open("POST", "Controller/php/eliminar_profesor.php")
