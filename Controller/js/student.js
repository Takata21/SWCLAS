...
function cargarUsuarios() {
    tabla.innerHTML = '<tr><th>ID</th><th>Nombre</th><th>Apellido</th><th>Usuario</th><th>Correo</th><th>telefono</th><th>fecha ultima clase</th><th>ultima clase</th></tr>'
    let peticion = new XMLHttpRequest();
    peticion.open("GET", "Controller/php/estuduantes.php");
    ...
    peticion.onload = function() {
        ...
        if (datos.error) {
            ...
            for (let index = 0; index < datos.length; index++) {
                ...
                elemento.innerHTML += "<td>" + datos[index].fuc + "</td>";
                elemento.innerHTML += "<td>" + datos[index].uc + "</td>";
...
function agregarUsuarios(e) {
    ...
    let peticion = new XMLHttpRequest()
    peticion.open("POST", "Controller/php/insertar_estudiantes.php");
    ...
    if (formulario_valido()) {
        ...
        let parametros = `nombre=${usuario_nombre}&apellido=${usuario_apellido}&usuario=${usuario_usuario}&pass=${usuario_pass}&email=${usuario_correo}&telefono=${usuario_telefono}`;
...
function eliminarUsuarios(e) {
    e.preventDefault()
    let peticion = new XMLHttpRequest()
    peticion.open("POST", "Controller/php/eliminar_estudiantes.php")
